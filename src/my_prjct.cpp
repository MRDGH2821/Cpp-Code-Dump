...
void student::show_tabular() {
  cout << rollno << setw(6) << " " << name << setw(10) << p_marks << setw(4)
       << c_marks << setw(4) << m_marks << setw(4) << e_marks << setw(4)
...
void delete_student(
    int); /*accept rollno and delete selected records from binary file*/
...
int main() {
  ...
  cout << setprecision(
      2); /* program outputs decimal number to two decimal places*/
  clrscr();
  intro();
